//! Sword crouch stab — crouched sword stance thrust with front-leg slide, then recover.
...
pub struct SwordCrouchStabBehavior {
    elapsed_ms: u32,
}

impl SwordCrouchStabBehavior {
    pub fn new() -> Self {
        Self { elapsed_ms: 0 }
    }
}

impl Behavior for SwordCrouchStabBehavior {
