//! Sword crouch stance — crouched one-handed sword ready pose.
...
pub struct SwordCrouchStanceBehavior;

impl SwordCrouchStanceBehavior {
    pub fn new() -> Self {
        Self
    }
}

impl Behavior for SwordCrouchStanceBehavior {
